...
/* Simple float to decimal string conversion */
...
int main(void)
{
    ...
    TEST_LOGGER("\n=== LC3370 Tests ===\n\n");
    TEST_LOGGER("Test 0: LC3370 (RISC-V Assembly)\n");
    ...
    TEST_LOGGER("\n=== Hanoi Tests ===\n\n");
    TEST_LOGGER("Test 1: Hanoi (RISC-V Assembly)\n");
    start_cycles = get_cycles();
    start_instret = get_instret();
    ...
    TEST_LOGGER("Test 2: Newton-Raphson (C)\n");
    start_cycles = get_cycles();
    start_instret = get_instret();
